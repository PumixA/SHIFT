...
export interface GameAction {
    id: string;
    type: 'dice_roll' | 'move' | 'rule_triggered' | 'effect_applied' | 'effect_expired' | 'power_up' | 'chat' | 'join' | 'leave' | 'rule_added' | 'rule_modified' | 'rule_deleted' | 'tile_added' | 'tile_removed' | 'victory';
    playerId: string;
    playerName?: string;
    description: string;
