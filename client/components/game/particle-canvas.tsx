...
export const ParticleCanvas = forwardRef<ParticleCanvasRef, ParticleCanvasProps>(({ className = "" }, ref) => {
    ...
    return <canvas ref={canvasRef} className={`pointer-events-none absolute inset-0 z-50 ${className}`} />
})
