...
export const TUTORIAL_SECTIONS: Record<TutorialSection, TutorialSectionInfo> = {
    ...
    rules: {
        id: "rules",
        title: "Les règles",
        description: "Système de règles dynamiques",
        icon: Book,
        stepRange: [3, 5],
    },
    ...
    advanced: {
        id: "advanced",
        title: "Avancé",
        description: "Victoire et contrôles",
        icon: Trophy,
        stepRange: [8, 10],
    },
}
...
export const TUTORIAL_STEPS: TutorialStep[] = [
    // Section: basics (0-2)
    {
        ...
        description:
            "SHIFT est un jeu de plateau avec des règles dynamiques. Chaque partie est unique grâce aux règles que vous créez et modifiez en cours de jeu.",
        icon: Trophy,
        section: "basics",
        position: "center",
    },
    {
        ...
        title: "Lancer le dé",
        description:
            "Cliquez sur le dé ou appuyez sur Espace pour le lancer. Votre pion avancera du nombre de cases indiqué.",
        icon: Dice5,
        section: "basics",
    ...
    },
    {
        ...
        title: "Déplacement",
        description:
            "Votre pion se déplace automatiquement sur le plateau. Observez les cases spéciales qui peuvent déclencher des effets !",
        icon: Footprints,
        section: "basics",
    ...
    // Section: rules (3-5)
    {
        ...
        description:
            "C'est ce qui rend SHIFT unique ! Les règles définissent ce qui se passe quand vous atterrissez sur une case, passez dessus, ou atteignez certains scores.",
        icon: Book,
        section: "rules",
    ...
    },
    {
        ...
        description:
            "Chaque règle a un déclencheur : 'Quand un joueur atterrit sur une case', 'Quand il lance un 6', etc. Les conditions peuvent être très variées !",
        icon: Zap,
        section: "rules",
        position: "center",
    },
    {
        ...
        description:
            "Après avoir joué, vous pouvez créer une nouvelle règle ! Choisissez un déclencheur, ajoutez des conditions, puis définissez les effets.",
        icon: Book,
        section: "rules",
    ...
    // Section: board (6-7)
    {
        ...
        description:
            "Clic droit sur une case pour voir les options. Vous pouvez ajouter des cases dans toutes les directions ou supprimer des cases existantes.",
        icon: Grid,
        section: "board",
        highlight: "[data-tutorial='board']",
        position: "left",
    ...
    },
    {
        ...
        description:
            "Certaines règles appliquent des effets qui durent plusieurs tours : bouclier, double dé, ralentissement... Surveillez vos effets actifs !",
        icon: Zap,
        section: "board",
    ...
    // Section: advanced (8-10)
    {
        ...
        title: "Objectif",
        description:
            "Le premier joueur à atteindre la dernière case ET avoir le plus de points gagne ! Les règles peuvent changer les conditions de victoire...",
        icon: Trophy,
        section: "advanced",
        position: "center",
    },
    {
        ...
        title: "Contrôles",
        description:
            "Clavier: Espace = dé, Flèches = navigation, R = règles. Manette: A = dé, Joystick = navigation, Y = règles.",
        icon: Gamepad2,
        section: "advanced",
        position: "center",
    ...
    },
    {
        ...
        description:
            "Bonne chance ! N'oubliez pas : dans SHIFT, les règles sont faites pour être changées. Soyez créatif et amusez-vous !",
        icon: CheckCircle2,
        section: "advanced",
        position: "center",
    },
            ...
            <AnimatePresence>
                {isVisible ? (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: 5 }}
                        className="absolute bottom-full left-1/2 z-50 mb-2 -translate-x-1/2 rounded-lg border border-white/10 bg-slate-800 px-3 py-2 text-sm whitespace-nowrap text-white/80"
                    >
                        {content}
