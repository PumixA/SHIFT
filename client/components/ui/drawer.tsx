...
function DrawerTitle({
    ...
    return (
        <DrawerPrimitive.Title
            ...
            {...({ className: cn("text-foreground font-semibold", className) } as Record<string, unknown>)}
        />
    )
}
...
function DrawerDescription({
    ...
    return (
        <DrawerPrimitive.Description
            ...
            {...({ className: cn("text-muted-foreground text-sm", className) } as Record<string, unknown>)}
        />
    )
}
