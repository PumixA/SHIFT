...
const CONDITION_INFO: Record<ConditionType, { name: string; description: string; valueType: string }> = {
  ...
  [ConditionType.POSITION_CHECK]: { name: 'Vérifier la position', description: 'Position sur le plateau', valueType: 'number' },
  ...
  [ConditionType.PLAYER_COUNT]: { name: 'Nombre de joueurs', description: 'Joueurs dans la partie', valueType: 'number' },
  [ConditionType.HAS_POWER_UP]: { name: 'A un power-up', description: 'Joueur avec power-up', valueType: 'text' },
  [ConditionType.PLAYER_RANK]: { name: 'Classement', description: 'Position dans le classement', valueType: 'number' },
  [ConditionType.TILES_FROM_END]: { name: 'Distance de la fin', description: 'Cases avant la fin', valueType: 'number' },
}
