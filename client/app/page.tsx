        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-lg space-y-12">
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter bg-gradient-to-r from-cyan-400 via-white to-violet-400 bg-clip-text text-transparent drop-shadow-2xl">
                        SHIFT
                    </h1>
                    <p className="text-sm md:text-base text-muted-foreground font-mono tracking-widest uppercase">
                    ...
                    {menuItems.map((item, index) => {
                        ...
                        return (
                            <Link key={item.id} href={item.href}>
                                <motion.div
                                    className={`
                                        relative group cursor-pointer p-4 md:p-5 rounded-xl
                                    ...
                                    <div className="relative z-10 flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className={`
                                                ...
                                                ${isSelected ? 'text-white/60' : 'text-muted-foreground/50'}
                                            `}>
                                                {item.description}
                                            </p>
                                        </div>
                                        ...
                                        <ChevronRight className={`
                                            ...
                                            ${isSelected ? 'text-white opacity-100 translate-x-0' : 'text-muted-foreground opacity-0 -translate-x-2'}
                                        `} />
                                    </div>
                                </motion.div>
                            </Link>
                ...
                >
                    <Link href="/profile">
                        <div className="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group">
                ...
                {/* Keyboard hint */}
                <motion.div
                    className="text-center text-xs text-muted-foreground/30 font-mono"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
