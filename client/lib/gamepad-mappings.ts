 ...
 */
export function vibrateGamepad(gamepad: Gamepad, intensity: number = 0.5, duration: number = 100): void {
    try {
...
// ================================
// EXTENDED GAMEPAD MAPPING FOR HOOKS
// ================================

export interface ExtendedGamepadMapping {
    name: string
    buttons: Record<number, GamepadAction>
    axes: Record<number, { positive: GamepadAction; negative: GamepadAction }>
}

export const GAMEPAD_MAPPINGS: Record<string, ExtendedGamepadMapping> = {
    xbox: {
        name: "Xbox",
        buttons: {
            0: "confirm", // A
