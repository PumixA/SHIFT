...
- **Branche principale**: `main` (Trunk-Based Development)
- **Commits**: Format Conventional Commits obligatoire
- **Feature Flags**: Utiliser pour le code incomplet en production
